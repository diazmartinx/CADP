...
var
	dol, cot, por, aux:real;
begin
	writeln('Ingrese monto en dolares:');read(dol);
	writeln('Ingrese cotizacion en pesos:');read(cot);
	writeln('Ingrese porcentaje de comision:');read(por);
	
	aux:= (dol*cot) * (1 + por/100);
	
	writeln('La transaccion sera de ',aux:2:2,' pesos argentinos');
	read();
end.
